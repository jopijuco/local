...
NO_STORES_PRODUCT_MESSAGE = f"{NO_STORES_MESSAGE} You need at least one to be able to add products."
NO_PRODUCT_MESSAGE = "You don't have any product registered or added to your stores."